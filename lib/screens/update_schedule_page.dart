...
class _UpdateSchedulePageState extends State<UpdateSchedulePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Update Schedule')),
      body: SafeArea(
        child: ListView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (state.step == WmtAuthStep.signedOut) ...[
                      const Text(
                        'Sign in through FAA MyAccess to refresh the schedule stored on this phone.',
                      ),
                      const SizedBox(height: 12),
                      FilledButton.icon(
                      ...
                      const Text(
                        'Your password stays inside the FAA page and is not stored by ATC Schedule Manager.',
                      ),
                      const SizedBox(height: 12),
                      FilledButton.icon(
